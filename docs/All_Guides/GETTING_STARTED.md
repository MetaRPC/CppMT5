...
> **Quick Setup & Overview** - Start automating your trading with CppMT5 (C++ for MetaTrader 5) in minutes.

---

## 🎯 What is CppMT5?

**CppMT5** is an industrial-grade, type-safe C++ client library for interacting with **MetaTrader 5** terminals via high-performance **gRPC**. It eliminates complex C++ DLL wrappers and provides direct, reliable programmatic trading.
...
Install CppMT5 via your standard C++ package manager:

```bash
vcpkg install metarpc-mt5
```
...
To get the most out of CppMT5, follow this suggested reading order:
